/**
 * Comprehensive Crop Database (286 crops)
...
export const CROP_DATABASE: Crop[] = [
  ...
  // ===== HEAT-LOVING LEAFY GREENS for ZONE 10 (10) =====
  {
    id: 'molokhia',
    name: 'Molokhia (Egyptian Spinach)',
    type: 'vegetable',
    botanical_family: 'Malvaceae',
    emoji: '🌿',
    sfg_density: 4,
    ...
    companions: {
      friends: ['okra', 'basil-sweet', 'amaranth'],
      enemies: [],
    },
  },
  {
    ...
    planting_strategy: { start_window_start: 2, start_window_end: 8 },
    companions: {
      friends: ['okinawa-spinach', 'malabar-spinach'],
      enemies: [],
    },
  },
  {
    ...
    planting_strategy: { start_window_start: 2, start_window_end: 8 },
    companions: {
      friends: ['longevity-spinach', 'malabar-spinach'],
      enemies: [],
    },
  },
  {
  ...
  },
  {
    ...
    planting_strategy: { start_window_start: -4, start_window_end: 4 },
    companions: {
      friends: ['onion-yellow', 'beet', 'dill'],
      enemies: ['tomato-beefsteak', 'strawberry'],
    },
  },
  {
  ...
  {
    id: 'magenta-spreen',
    name: 'Magenta Spreen (Tree Spinach)',
    type: 'vegetable',
    botanical_family: 'Amaranthaceae',
    emoji: '🌿',
    sfg_density: 4,
    ...
    planting_strategy: { start_window_start: -2, start_window_end: 6 },
    companions: {
      friends: ['amaranth', 'orach-magenta'],
      enemies: [],
    },
  },
  {
    ...
    planting_strategy: { start_window_start: -8, start_window_end: 2 },
    companions: {
      friends: ['lettuce-leaf', 'mache'],
      enemies: [],
    },
  },
  // ===== MEDITERRANEAN & SUBTROPICAL HERBS (10) =====
  {
    id: 'cuban-oregano',
    name: 'Cuban Oregano',
    type: 'herb',
    ...
    planting_strategy: { start_window_start: 1, start_window_end: 6 },
    companions: {
      friends: ['rosemary', 'oregano', 'thyme'],
      enemies: [],
    },
  },
  {
    id: 'mexican-mint-marigold',
    ...
    planting_strategy: { start_window_start: 0, start_window_end: 6 },
    companions: {
      friends: ['tomato-beefsteak', 'marigold-french', 'pepper-bell'],
      enemies: [],
    },
  },
  {
  ...
  },
  {
    ...
    planting_strategy: { start_window_start: 0, start_window_end: 6 },
    companions: {
      friends: ['basil-sweet', 'tomato-beefsteak', 'pepper-bell'],
      enemies: [],
    },
  },
  {
    ...
    planting_strategy: { start_window_start: 1, start_window_end: 6 },
    companions: {
      friends: ['tomato-beefsteak', 'pepper-bell', 'oregano'],
      enemies: [],
    },
  },
  {
    ...
    planting_strategy: { start_window_start: -2, start_window_end: 4 },
    companions: {
      friends: ['rosemary', 'thyme', 'lavender'],
      enemies: ['peas-sugar-snap', 'green-beans-bush'],
    },
  },
  {
    ...
    planting_strategy: { start_window_start: 1, start_window_end: 6 },
    companions: {
      friends: ['tomato-beefsteak', 'pepper-bell', 'borage'],
      enemies: [],
    },
  },
  {
    ...
    planting_strategy: { start_window_start: 1, start_window_end: 6 },
    companions: {
      friends: ['tomato-beefsteak', 'pepper-bell', 'marigold-french'],
      enemies: [],
    },
  },
  {
    ...
    companions: {
      friends: ['cabbage', 'broccoli'],
      enemies: ['parsley-flat', 'parsley-curly'],
    },
  },
  {
    id: 'moroccan-mint',
    ...
    planting_strategy: { start_window_start: -2, start_window_end: 6 },
    companions: {
      friends: ['cabbage', 'broccoli', 'tomato-beefsteak'],
      enemies: ['parsley-flat', 'parsley-curly'],
    },
  },
  // ===== HEAT-LOVING FRUITING VEGETABLES (10) =====
  {
    id: 'mexican-sour-gherkin',
    name: 'Mexican Sour Gherkin (Cucamelon)',
    type: 'vegetable',
    botanical_family: 'Cucurbitaceae',
    emoji: '🥒',
    sfg_density: 1,
    ...
    planting_strategy: { start_window_start: 2, start_window_end: 6 },
    companions: {
      friends: ['nasturtium', 'marigold-french', 'sunflower'],
      enemies: ['potato', 'sage'],
    },
  },
  {
    ...
    planting_strategy: { start_window_start: 2, start_window_end: 6 },
    companions: {
      friends: ['basil-sweet', 'cilantro', 'marigold-french'],
      enemies: ['fennel'],
    },
  },
  {
  ...
  },
  {
    ...
    planting_strategy: { start_window_start: 1, start_window_end: 6 },
    companions: {
      friends: ['cilantro', 'pepper-bell', 'basil-sweet'],
      enemies: ['fennel'],
    },
  },
  {
  ...
  },
  {
    ...
    planting_strategy: { start_window_start: 2, start_window_end: 6 },
    companions: {
      friends: ['basil-sweet', 'green-beans-bush', 'marigold-french'],
      enemies: ['fennel'],
    },
  },
  {
    ...
    planting_strategy: { start_window_start: 2, start_window_end: 6 },
    companions: {
      friends: ['basil-thai', 'cilantro', 'marigold-french'],
      enemies: ['fennel'],
    },
  },
  {
    ...
    planting_strategy: { start_window_start: 2, start_window_end: 6 },
    companions: {
      friends: ['corn-sweet', 'okra', 'nasturtium'],
      enemies: ['potato'],
    },
  },
  {
  ...
  },
  {
    ...
    planting_strategy: { start_window_start: -2, start_window_end: 4 },
    companions: {
      friends: ['orach-magenta', 'magenta-spreen'],
      enemies: [],
    },
  },
  {
    id: 'roselle',
    name: 'Roselle (Sorrel Hibiscus)',
    type: 'herb',
    botanical_family: 'Malvaceae',
    emoji: '🌺',
    sfg_density: 1,
    ...
    planting_strategy: { start_window_start: 2, start_window_end: 6 },
    companions: {
      friends: ['cranberry-hibiscus', 'okra'],
      enemies: [],
    },
  },
  {
    id: 'tithonia-mexican-sunflower',
    ...
    planting_strategy: { start_window_start: 0, start_window_end: 6 },
    companions: {
      friends: ['cucumber', 'pepper-bell', 'sunflower'],
      enemies: [],
    },
  },
  {
    id: 'day-lily-edible',
    name: 'Day Lily (Edible)',
    type: 'flower',
  ...
  },
  {
    ...
    planting_strategy: { start_window_start: 0, start_window_end: 6 },
    companions: {
      friends: ['zinnia', 'cosmos', 'marigold-french'],
      enemies: [],
    },
  },
  {
    ...
    planting_strategy: { start_window_start: 0, start_window_end: 6 },
    companions: {
      friends: ['cosmos', 'zinnia', 'marigold-french'],
      enemies: [],
    },
  },
  {
    ...
    planting_strategy: { start_window_start: 1, start_window_end: 6 },
    companions: {
      friends: ['corn-sweet', 'pumpkin-pie', 'amaranth'],
      enemies: ['onion-yellow', 'garlic'],
    },
  },
  {
