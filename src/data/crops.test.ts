...
describe('CROP_DATABASE', () => {
  it('has exactly 286 crops', () => {
    expect(CROP_DATABASE).toHaveLength(286)
  })
  ...
  it('all crops have unique IDs', () => {
    ...
    expect(uniqueIds.size).toBe(286)
  })
...
describe('CROPS_BY_ID', () => {
  it('provides lookup object with all 286 crops', () => {
    expect(Object.keys(CROPS_BY_ID)).toHaveLength(286)
  })
