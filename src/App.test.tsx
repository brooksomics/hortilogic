...
describe('App', () => {
  ...
  it('displays crops from expanded database (246 crops) in library', () => {
    renderApp()
  ...
  it('loads expanded crop database (246 crops)', () => {
    renderApp()

    // Should display crop count showing 246 crops
    expect(screen.getByText(/246 crops/i)).toBeInTheDocument()
  })
})
